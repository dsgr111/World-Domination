...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    vec2 mousePos = (iMouse.xy * iResolution.xy * 2.0 - iResolution.xy) / min(iResolution.x, iResolution.y);
    float mouseDist = length(uv - mousePos);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    vec2 mousePos = (iMouse.xy - 0.5) * 2.0;
...
export const shaderThemes = [
  { id: "shader-waves" as const, name: "Волны", fragmentShader: flowingWavesShader },
  { id: "shader-ether" as const, name: "Эфир", fragmentShader: etherShader },
  { id: "shader-stars" as const, name: "Звезды", fragmentShader: shootingStarsShader },
  { id: "shader-lines" as const, name: "Линии", fragmentShader: wavyLinesShader },
  { id: "shader-plasma" as const, name: "Плазма", fragmentShader: plasmaFlowShader },
  { id: "shader-particles" as const, name: "Частицы", fragmentShader: particleFieldShader },
  { id: "shader-voronoi" as const, name: "Вороной", fragmentShader: voronoiCellsShader },
  { id: "shader-aurora" as const, name: "Аврора", fragmentShader: auroraWavesShader },
  { id: "shader-fractal" as const, name: "Фрактал", fragmentShader: fractalNoiseShader },
];
